...
// reference:
// https://github.com/mafintosh/is-my-json-valid/blob/master/formats.js#L7
        formats.uri = /^([a-zA-Z][a-zA-Z0-9+-.]*:){0,1}\/\/[^\s]*$/;
// reference:
// http://stackoverflow.com/questions/201323/using-a-regular-expression-to-validate-an-email-address#answer-8829363
// http://www.w3.org/TR/html5/forms.html#valid-e-mail-address (search for
// 'willful violation')
...
// reference:
// http://stackoverflow.com/questions/106179/regular-expression-to-match-dns-hostname-or-ip-address#answer-3824105
        ...
        module.exports = function func() {
            ...
            builder.compile = function (scope) {
                var src = 'return (' + builder.toSource() + ')',
                    scp = scope || {},
                    keys = _.keys(scp),
                    vals = _.map(keys, function (key) {
                        return scp[key];
                    });

                var myargs = keys.concat(src);

                var ret1 = Function.apply(null, myargs);
                var ret2 = ret1.apply(null, vals);
    ...
    4: [function (require, module, exports) {
        ...
        var PATH_REPLACE_EXPR = /\[.+?\]/g,
            ...
            browser = typeof window === 'object' && !!window.navigator,   // jshint
        // ignore:
        // line
        ...
        keywords.type = function (context) {
            ...
            var specified = Array.isArray(context.schema.type) ? context.schema.type : [context.schema.type],
                src = _.map(specified, function mapType(type) {
        ...
        keywords.maxProperties = function (context) {
            if (isInteger(context.schema.maxProperties)) {
                context.code('if (_.keys(' + context.path + ').length > ' + context.schema.maxProperties + ') {');
        ...
        keywords.minProperties = function (context) {
            if (isInteger(context.schema.minProperties)) {
                context.code('if (_.keys(' + context.path + ').length < ' + context.schema.minProperties + ') {');
        ...
        keywords.properties = function (context) {
            ...
            var props = context.schema.properties,
                propKeys = type(props) === 'object' ? _.keys(props) : [],
                patProps = context.schema.patternProperties,
                patterns = type(patProps) === 'object' ? _.keys(patProps) : [],
                addProps = context.schema.additionalProperties,
                addPropsCheck = addProps === false || type(addProps) === 'object',
                prop, i, nestedPath;

            // do not use this generator if we have patternProperties or
        ...
        keywords.patternProperties = keywords.additionalProperties = function (context) {
            ...
            context.code(keys + ' = _.keys(' + context.path + ')');
        ...
        function getGenerators(schema) {
            ...
            return start.concat(_.keys(perType).reduce(function (arr, key) {
            ...
            function compile(schema) {
                ...
                function validate(path, schema, noFailFast) {
                    ...
                    function error(keyword, key) {
                        ...
                        if (path.indexOf('[') > -1) {
                            // create error objects dynamically when path
                            // contains indexed property expressions
                            ...
                            // generate faster code when no indexed properties
                            // in the path
                            varid = id();
        ...
        module.exports = jsen;
        Function('return this')().jsen = jsen;

    }, {"./equal.js": 1, "./formats.js": 2, "./func.js": 3, "./resolver.js": 6, "./unique.js": 7}],
...
// http://tools.ietf.org/html/draft-ietf-appsawg-json-pointer-08#section-3
        ...
        function refFromId(obj, ref) {
            if (obj && typeof obj === 'object') {
                ...
                return _.keys(obj).reduce(function (resolved, key) {
        ...
        function SchemaResolver(rootSchema, external, missing$Ref) {  // jshint
            // ignore:
            // line
